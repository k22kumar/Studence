...
const FullAd = (props) => {
    ...
    return (
        <ul className="flexParent flexColumn fullAdContainer">
            ...
            <li>
                <button className="siteButton" onClick={downloadPoster}>Download Poster</button>
            </li>
        </ul>
    )
}
